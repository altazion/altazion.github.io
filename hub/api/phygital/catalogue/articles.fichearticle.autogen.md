## <span id='fichearticle'>Fiche article</span>

Récupère la fiche produit d'un article

Url :`[GET] v2/catalogue/get/{guid:guid}`

Paramètres : 

- **guid** (Guid) : L'identifiant de l'article

Url :`[GET] v2/catalogue/get/{reference}`

Paramètres : 

- **reference** (string) : La référence de l'article
