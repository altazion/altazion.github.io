## <span id='fichearticledepublie'>Fiche article (dépublié)</span>

Récupère les infos principales d'un produit qui n'est plus publié

Url :`[GET] v2/catalogue/get/{reference}/unpublished`

Paramètres : 

- **reference** (string)

Url :`[GET] v2/catalogue/get/{guid:guid}/unpublished`

Paramètres : 

- **guid** (Guid)

Type de retour : `ArticlePhygitalWithParent`
