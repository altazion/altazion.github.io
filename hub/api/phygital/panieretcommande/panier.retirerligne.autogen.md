## <span id='retirerligne'>Retirer une ligne du panier</span>

Retire une ligne du panier

Url :`[GET] v2/cart/remove/{ligneGuid:guid}`

Paramètres : 

- **ligneGuid** (Guid) : L'identifiant de ligne qui doit être supprimée
