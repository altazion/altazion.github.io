## <span id='adrlivraisondefinir'>Créer un nouveau client</span>

Change l'adresse de livraison de la commande en cours (pour les livraisons au domicile)

Url :`[GET] v2/process/livraison/adresse/{guid:guid}`
