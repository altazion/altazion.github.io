## <span id='obtenir'>Obtenir un devis</span>

Récupère une dernière révision de devis

Url :`[GET] api/ventes/devis/{devisId}`

Paramètres : 

- **devisId** (long) : L'identifiant du devis

Url :`[GET] api/ventes/devis/revision/{devisNumero}`

Paramètres : 

- **devisNumero** (string) : Le numéro du devis
