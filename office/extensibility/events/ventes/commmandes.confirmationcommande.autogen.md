## <span id='confirmationcommande'>Confirmation Commande</span>

Cet évènement est déclenché lorsqu'une commande est confirmée et entre dans l'OMS

Informations sur l'évènement : 

 - **Catégorie** : e/rp
 - **Code** : ConfirmationBcd
