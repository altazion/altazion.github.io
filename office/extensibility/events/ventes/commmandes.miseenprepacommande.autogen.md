## <span id='miseenprepacommande'>Mise en prépa Commande</span>

Cet évènement est déclenché lorsqu'une commande est confirmée et va être mis en préparation
...
class OmsCommandePreparationEventData
{
